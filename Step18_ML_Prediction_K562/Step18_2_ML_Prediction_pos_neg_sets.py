...
def main():
    ...
    chip_data = pd.read_csv("../../public/Multiomics/Step18_ML_Prediction_K562/hg38_bin.csv")
    ...
    positive_set_export.to_csv("../../public/Multiomics/Step18_ML_Prediction_K562/hg38_bin_positive.csv", index=False)
    ...
    negative_set.to_csv("../../public/Multiomics/Step18_ML_Prediction_K562/hg38_bin_negative.csv", index=False)
