...
if __name__ == '__main__':
    ...
    base_path_chipseq = '../../public/Public Dataset/ChIPseq/Other Cell Lines/K562/'
    histone_map = {
        'H3K4me1': os.path.join(base_path_chipseq, 'K562 H3K4me1 ChIPseq GSM733692 ENCFF100FDI hg38.bigWig'),
        'H3K4me2': os.path.join(base_path_chipseq, 'K562 H3K4me2 ChIPseq GSM733651 ENCFF054RSU hg38.bigWig'),
        'H3K4me3': os.path.join(base_path_chipseq, 'K562 H3K4me3 ChIPseq GSE96303 ENCFF405ZDL hg38.bigWig'),
        'H3K9ac': os.path.join(base_path_chipseq, 'K562 H3K9ac ChIPseq GSM733778 ENCFF239EBH hg38.bigWig'),
        'H3K9me3': os.path.join(base_path_chipseq, 'K562 H3K9me3 ChIPseq GSM733776 ENCFF632NQA hg38.bigWig'),
        'H3K27ac': os.path.join(base_path_chipseq, 'K562 H3K27ac ChIPseq GSM733656 ENCFF469JMR hg38.bigWig'),
        'H3K27me3': os.path.join(base_path_chipseq, 'K562 H3K27me3 ChIPseq GSM733658 ENCFF665RDD hg38.bigWig'),
        'H3K36me3': os.path.join(base_path_chipseq, 'K562 H3K36me3 ChIPseq GSM733714 ENCFF296TSL hg38.bigWig'),
        'H4K20me1': os.path.join(base_path_chipseq, 'K562 H4K20me1 ChIPseq GSM733675 ENCFF694ODT hg38.bigWig')
    }

    # Define paths for the input and output CSV files
    base_path_multiomics = '../../public/Multiomics/Step18_ML_Prediction_K562/'
