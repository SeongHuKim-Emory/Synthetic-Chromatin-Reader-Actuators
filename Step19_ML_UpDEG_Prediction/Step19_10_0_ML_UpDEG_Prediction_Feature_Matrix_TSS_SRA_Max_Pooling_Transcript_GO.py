...
UPDEG_PATH = '../../public/Multiomics/Step19_ML_UpDEG_Prediction/GeneHancer_Genes_Elements_RNAseq_SRA_Specific_UpDEG_TSS_SRA_Max_Pool_Histone_RNA.csv'
NON_DEG_PATH = '../../public/Multiomics/Step19_ML_UpDEG_Prediction/GeneHancer_Genes_Elements_RNAseq_Non_DEG_TSS_SRA_Max_Pool_Histone_RNA.csv'
GO_ANNOTATION_PATH = '../../public/Public Dataset/GO/goa_human header trimmed.csv'

GO_MATRIX_OUTPUT_PATH = '../../public/Multiomics/Step19_ML_UpDEG_Prediction/GO_Matrix.csv'

# FIX: Shorten output file paths to avoid OS path length limits.
UPDEG_GO_OUTPUT_PATH = '../../public/Multiomics/Step19_ML_UpDEG_Prediction/SRA_Specific_UpDEG_with_GO.csv'
NON_DEG_GO_OUTPUT_PATH = '../../public/Multiomics/Step19_ML_UpDEG_Prediction/Non_DEG_with_GO.csv'
