...
if __name__ == "__main__":
    ...
    updeg_input_path = '../../public/Multiomics/Step19_ML_UpDEG_Prediction/GeneHancer_Genes_Elements_RNAseq_SRA_Specific_UpDEG_TSS_SRA.csv'
    updeg_output_path = '../../public/Multiomics/Step19_ML_UpDEG_Prediction/GeneHancer_Genes_Elements_RNAseq_SRA_Specific_UpDEG_TSS_SRA_Max_Pool.csv'

    # Define file paths for the Non-DEG dataset
    non_deg_input_path = '../../public/Multiomics/Step19_ML_UpDEG_Prediction/GeneHancer_Genes_Elements_RNAseq_Non_DEG_TSS_SRA.csv'
    non_deg_output_path = '../../public/Multiomics/Step19_ML_UpDEG_Prediction/GeneHancer_Genes_Elements_RNAseq_Non_DEG_TSS_SRA_Max_Pool.csv'
