...
if __name__ == "__main__":
    ...
    # Input file paths
    up_deg_input_csv = '../../public/Multiomics/Step19_ML_UpDEG_Prediction/GeneHancer_Genes_Elements_RNAseq_SRA_Specific_UpDEG_TSS.csv'
    non_deg_input_csv = '../../public/Multiomics/Step19_ML_UpDEG_Prediction/GeneHancer_Genes_Elements_RNAseq_Non_DEG_TSS.csv'
    bigwig_file_path = '../../public/ChIPseq/SHK_2024_06_11_MCF7_DBN025_1_0_ug_mL_Rep2_ppois.bigWig'

    # Output file paths
    up_deg_output_csv = '../../public/Multiomics/Step19_ML_UpDEG_Prediction/GeneHancer_Genes_Elements_RNAseq_SRA_Specific_UpDEG_TSS_SRA.csv'
    non_deg_output_csv = '../../public/Multiomics/Step19_ML_UpDEG_Prediction/GeneHancer_Genes_Elements_RNAseq_Non_DEG_TSS_SRA.csv'
