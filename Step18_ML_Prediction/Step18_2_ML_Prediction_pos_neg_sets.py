...
def main():
    ...
    chip_data = pd.read_csv("../../public/Multiomics/hg38_bin.csv")
    ...
    positive_set_export.to_csv("../../public/Multiomics/hg38_bin_positive.csv", index=False)
    ...
    negative_set.to_csv("../../public/Multiomics/hg38_bin_negative.csv", index=False)
