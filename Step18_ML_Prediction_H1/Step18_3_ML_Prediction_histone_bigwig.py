...
if __name__ == '__main__':
    ...
    base_path_chipseq = '../../public/Public Dataset/ChIPseq/Other Cell Lines/H1/'
    histone_map = {
        'H3K4me1': os.path.join(base_path_chipseq, 'H1 H3K4me1 ChIPseq GSM733782 ENCFF706CHK hg38.bigWig'),
        'H3K4me2': os.path.join(base_path_chipseq, 'H1 H3K4me2 ChIPseq GSM733670 ENCFF556VEB hg38.bigWig'),
        'H3K4me3': os.path.join(base_path_chipseq, 'H1 H3K4me3 ChIPseq GSE96392 ENCFF698DKQ hg38.bigWig'),
        'H3K9ac': os.path.join(base_path_chipseq, 'H1 H3K9ac ChIPseq GSM537685 ENCFF225ZYN hg38.bigWig'),
        'H3K9me3': os.path.join(base_path_chipseq, 'H1 H3K9me3 ChIPseq GSM1003585 ENCFF441SLB hg38.bigWig'),
        'H3K27ac': os.path.join(base_path_chipseq, 'H1 H3K27ac ChIPseq GSM733718 ENCFF771GNB hg38.bigWig'),
        'H3K27me3': os.path.join(base_path_chipseq, 'H1 H3K27me3 ChIPseq GSM433167 ENCFF927FVH hg38.bigWig'),
        'H3K36me3': os.path.join(base_path_chipseq, 'H1 H3K36me3 ChIPseq GSM733725 ENCFF985CVI hg38.bigWig'),
        'H4K20me1': os.path.join(base_path_chipseq, 'H1 H4K20me1 ChIPseq GSM733687 ENCFF674EST hg38.bigWig')
    }

    # Define paths for the input and output CSV files
    base_path_multiomics = '../../public/Multiomics/Step18_ML_Prediction_H1/'
