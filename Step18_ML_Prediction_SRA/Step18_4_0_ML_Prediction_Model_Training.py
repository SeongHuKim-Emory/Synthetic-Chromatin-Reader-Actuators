...
from matplotlib.colors import LinearSegmentedColormap  # Added for custom gradient
...
# --- Configuration ---
POSITIVE_SET_PATH = "../../public/multiomics/Step18_ML_Prediction_SRA/hg38_bin_positive_histone.csv"
NEGATIVE_SET_PATH = "../../public/multiomics/Step18_ML_Prediction_SRA/hg38_bin_negative_histone.csv"
OUTPUT_DIR = "../../public/multiomics/Step18_ML_Prediction_SRA"
...
if HAVE_SHAP:
    ...
    # -------------------------------------------------------------------------
    # MODIFICATION: Global SHAP summary with custom Top 5% Red / 95% Blue map
    # -------------------------------------------------------------------------
