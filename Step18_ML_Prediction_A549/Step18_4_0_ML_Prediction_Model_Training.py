...
if HAVE_SHAP:
    ...
    # ------------------------------------------------------------------
    from shap.plots import colors as shap_colors  # SHAP's plotting colors [web:6]
    ...
    def plot_shap_dependence_with_global_colors(
        ...
        """
        if cmap is None:
            cmap = shap_colors.red_blue  # SHAP's default dependence colormap [web:6]
        ...
        # Sort by color value so low-valued points are drawn first, high last [web:9]
