...
base_output_dir = '../../public/Multiomics/Step23_Histone_Feature_Comparison_All_Genes/'

# File 1: Process the Up-regulated DEGs file
updeg_input_file = os.path.join(base_input_dir, 'SRA_Specific_UpDEG_with_GO.csv')
updeg_output_file = os.path.join(base_output_dir, 'SRA_Specific_UpDEG_with_GO_Select_Features.csv')
process_and_filter_data_polars(updeg_input_file, updeg_output_file)

print("-" * 50)

# File 2: Process the Non-DEGs file
non_deg_input_file = os.path.join(base_input_dir, 'Non_DEG_with_GO.csv')
non_deg_output_file = os.path.join(base_output_dir, 'Non_DEG_with_GO_Select_Features.csv')
